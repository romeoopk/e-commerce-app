package com.e_commerce_app.notification.service;

import com.e_commerce_app.notification.dto.EmailTemplates;
import com.e_commerce_app.notification.dto.PaymentConfirmation;
import com.e_commerce_app.notification.dto.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail, String customerName, BigDecimal amount, String orderReference) throws MessagingException {
        ...
        mimeMessageHelper.setFrom("romeoopk@gmail.com");
        mimeMessageHelper.setTo("romeoopk@gmail.com");
        ...
        try {
            ...
            //mimeMessageHelper.setText(destinationEmail);
